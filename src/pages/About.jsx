    ...
    <>
      <div className="container pt-14">
        <div className=" flex flex-col lg:flex-row">
          <div className="py-10 lg:w-1/2">
            ...
            <p>
              ...
              service and value. Whether you're looking for luxury, adventure,
              or cultural exploration, Travello.in is here to make your travel
              dreams come true.
            </p>
            ...
            <ul className="mb-3">
              ...
              <li>
                Our expertly guided group tours are designed to provide a
                seamless blend of enriching sightseeing opportunities, leisure
                activities, and social interactions, ensuring a well-rounded
                travel experience for every participant.
              </li>
              <li>
                For corporate travelers, Travello.in provides comprehensive
                travel management solutions, guaranteeing efficient and
                hassle-free arrangements so you can remain focused on your
        ...
        <p>
          ...
          worldwide, staying up-to-date with the latest travel trends to provide
          personalized recommendations.
        </p>
        <p>
          We collaborate with trusted partners, including airlines, hotels, and
          local tour operators, to deliver high-quality services and memorable
          experiences. Our support team is available 24/7 to assist you with any
          queries or emergencies during your trip. Committed to responsible and
          sustainable travel practices, we minimize our environmental impact and
          support local communities through our initiatives.
        </p>
      </div>
      <Testimonial />
      <Location />
